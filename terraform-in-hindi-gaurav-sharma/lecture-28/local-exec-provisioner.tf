resource "aws_instance" "web_instance" {
  ...
  # local-exec provisioner runs a command on the machine where Terraform is being executed
  # provisioners run in the order they are defined
  ...
  # you can execute python or any other scripts as well
  provisioner "local-exec" {
